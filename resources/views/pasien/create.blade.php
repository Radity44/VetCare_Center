...
@section('content')
    <form method="POST" action="{{ route('pasien.store') }}"
        class="max-w-2xl mx-auto bg-white p-6 rounded-xl shadow-lg space-y-4">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input name="nama_hewan" value="{{ old('nama_hewan') }}" required
            ...
            <div>
                ...
                <input name="jenis_hewan" value="{{ old('jenis_hewan') }}" required
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input name="ras" value="{{ old('ras') }}" placeholder="Contoh: Persian, Golden Retriever"
                    class="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                @error('ras')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
        ...
        <div>
            ...
            <div class="flex gap-2 items-center">
                <input type="number" name="umur_hewan" value="{{ old('umur_hewan') }}" min="0" placeholder="0"
        ...
        <div>
            ...
            <input name="judul_perawatan" value="{{ old('judul_perawatan') }}"
        ...
        <div>
            ...
            <input name="nama_pemilik" value="{{ old('nama_pemilik') }}" placeholder="Nama lengkap pemilik hewan"
                class="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            @error('nama_pemilik')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
            @enderror
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input name="telepon_pemilik" value="{{ old('telepon_pemilik') }}" placeholder="08xxxxxxxxxx"
                    class="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div>
                ...
                <input name="alamat_pemilik" value="{{ old('alamat_pemilik') }}" placeholder="Alamat lengkap"
                    class="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
        ...
        <div>
            ...
            <textarea name="riwayat_perawatan" rows="3" placeholder="Catatan riwayat perawatan sebelumnya (jika ada)"
        ...
        <div class="flex justify-between pt-4">
            <button class="px-6 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold transition shadow"
                type="submit">
                Simpan
            </button>
