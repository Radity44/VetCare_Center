...
<head>
    ...
    <title>Struk Kunjungan - {{ $invoiceNumber }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="invoice-info">
        <table>
            ...
            <tr>
                ...
                <td><span class="status-badge">{{ $kunjungan->status }}</span></td>
            </tr>
            <tr>
    ...
    <table class="info-table">
        <tr>
            <td>Nama Hewan</td>
            <td>: {{ $kunjungan->patient->nama_hewan }}</td>
        </tr>
        <tr>
            <td>Jenis Hewan</td>
            <td>: {{ $kunjungan->patient->jenis_hewan }}</td>
        </tr>
        <tr>
            <td>Ras</td>
            <td>: {{ $kunjungan->patient->ras ?? '-' }}</td>
        </tr>
        <tr>
            <td>Umur</td>
            <td>: {{ $kunjungan->patient->umur_lengkap }}</td>
        </tr>
        <tr>
            <td>Jenis Kelamin</td>
            <td>: {{ $kunjungan->patient->jenis_kelamin }}</td>
        </tr>
        <tr>
            <td>Pemilik</td>
            <td>: {{ $kunjungan->patient->nama_pemilik ?? '-' }}</td>
        </tr>
        <tr>
            <td>Telepon Pemilik</td>
            <td>: {{ $kunjungan->patient->telepon_pemilik ?? '-' }}</td>
        </tr>
    </table>
    
    <!-- Data Medis -->
    <div class="section-title">👨‍⚕️ DATA MEDIS</div>
    <table class="info-table">
        <tr>
            <td>Dokter</td>
    ...
    <div class="footer">
        ...
        <p>Semoga hewan kesayangan Anda segera sehat kembali</p>
